...
1. [Governança](GOVERNANCA_DOCUMENTACAO.md)
2. [Registro de Itens do Roadmap](roadmap/REGISTRO_ITENS_ROADMAP.md)
3. [Roadmap do Produto](roadmap/ROADMAP_PRODUTO.md)
4. [Board de Orquestração](roadmap/BOARD_ORQUESTRACAO.md)
5. [Histórico de Entregas](roadmap/HISTORICO_ENTREGAS.md)
6. Backlog do domínio aplicável
7. Decisões ativas

## Produto e descoberta

- [Visão do Produto](visao/VISAO_PRODUTO.md)
- [Escopo e Fora de Escopo](visao/ESCOPO.md)
- [Benchmark Veri e Contabilizei](visao/BENCHMARK_VERI_CONTABILIZEI.md)
- [Plano de observação do trial](discovery/PLANO_OBSERVACAO_TRIAL.md)

## Arquitetura

- [Arquitetura Base](arquitetura/ARQUITETURA_BASE.md)
- [Módulos Common](arquitetura/MODULOS_COMMON.md)
...
- [DEC-DEP-001 — On-premise first](decisoes/DEC-DEP-001_ON_PREMISE_FIRST.md)
- [Índice de decisões](decisoes/INDICE_DECISOES.md)
...
- [Módulos futuros](roadmap/BACKLOG_MODULOS_FUTUROS.md)

## Codex e orquestração

- [Fluxo de Trabalho Codex](ai/FLUXO_TRABALHO_CODEX.md)
