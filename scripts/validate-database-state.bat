...
echo [OK] Flyway V1-V11 aplicado sem registro de falha.
echo [OK] Ledger anti-replay da sessao interativa presente.
echo [OK] Estruturas de empresas e faturas de providers presentes.
echo.
